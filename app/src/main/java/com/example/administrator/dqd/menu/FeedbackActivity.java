...
public class FeedbackActivity extends FragmentActivity {
    ...
    TextView feedback_left,feedback_right;
    ...
    private void initListen() {
        ...
        feedback_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                feedback_left.setTextColor(FeedbackActivity.this.getResources().getColor(R.color.green));
                feedback_right.setTextColor(FeedbackActivity.this.getResources().getColor(R.color.black));
                //设置下划线显示隐藏
        ...
        feedback_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                feedback_left.setTextColor(FeedbackActivity.this.getResources().getColor(R.color.black));
                feedback_right.setTextColor(FeedbackActivity.this.getResources().getColor(R.color.green));
