...
public class HomeSoccerActivity2 extends Activity {
   ...
   "本周赛事看点：曼城复仇热刺？国米倒戈罗马？","伊涅斯塔：对阵巴萨是一次前所未有的体验，一定会很刺激","纳尔多：努力为西班牙人争取最好的联赛排名" };
    ...
    private void initData() {
        content_writer.setText(writer[(position%6)]);
        content_title.setText(title[(position%6)]);
        content_pic.setImageResource(pictureId[(position%6)]);
        content_content.setText(content[(position%6)]);
        ...
        button_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button_share.getText()=="21分享"){
                    Toast.makeText(HomeSoccerActivity2.this, "已分享过了", Toast.LENGTH_SHORT).show();

                }else{
                    Toast.makeText(HomeSoccerActivity2.this, "已分享给好友", Toast.LENGTH_SHORT).show();
        ...
        button_agree.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button_agree.getText()=="172赞"){
                    Toast.makeText(HomeSoccerActivity2.this, "取消点赞", Toast.LENGTH_SHORT).show();
                    button_agree.setText("171赞");
                }else{
                    Toast.makeText(HomeSoccerActivity2.this, "已点赞", Toast.LENGTH_SHORT).show();
    ...
    private void status() {
        //状态栏设置
        Window window = HomeSoccerActivity2.this.getWindow();
        ...
        ViewGroup mContentView = HomeSoccerActivity2.this.findViewById(Window.ID_ANDROID_CONTENT);
