...
public class ShopActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window =ShopActivity.this.getWindow();
        ...
        ViewGroup mContentView = ShopActivity.this.findViewById(Window.ID_ANDROID_CONTENT);
    ...
    private void setGestureListener(){
        ...
        linearLayout = findViewById(R.id.shop_linearLayout);
